...
const styles = reactive<{
  ...
  primary: '',
  success:
    'dark:from-green-500/50 via-gray-200 to-gray-200 dark:via-zinc-800 dark:to-zinc-800',
  warning:
    'dark:from-yellow-500/50 via-gray-200 to-gray-200 dark:via-zinc-800 dark:to-zinc-800',
  danger:
    'dark:from-red-500/50 via-gray-200 to-gray-200 dark:via-zinc-800 dark:to-zinc-800',
})
...
<template>
  <TransitionRoot :show="!isDestroyed" appear>
    ...
    >
      <div
        :class="`bg-gray-200 dark:bg-zinc-800 bg-gradient-to-r shadow-white/50 dark:shadow-zinc-900/50 px-6 py-6 rounded-md shadow-lg flex space-x-6 ${selectedStyle}`"
      >
        ...
        <div>
          <button
            class="text-zinc-600 hover:text-red-500 dark:text-gray-400 font-bold"
            @click="close"
          >
